...
* __duration__   - (*number*: defaults to 500) The duration of the effect in ms. Can also be one of:
	...
	* -'normal' - 500ms
	* -'long'   - 1000ms
* __Transition__ - (*function*: defaults to ['sine:in:out'](/Fx/Fx.Transitions) The equation to use for the effect see [Fx.Transitions](/Fx/Fx.Transitions). Also accepts a string in the following form:
